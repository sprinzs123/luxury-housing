      ...
      <div className="footer-main grey-1">
        <div className="container">
          <div className="smaller-footer green row">
            ...
            <div className="col-lg-6">
              <div className="btn-footer row d-flex justify-content-start mt-3">
                <div className="col-sm-6">
                  <div className=" btn-green col-sm-6">BOOK YOUR TOUR</div>
                </div>
                <div className="col-sm-6">
                  <div className="btn-green col-6">BOOK YOUR TOUR</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row d-flex justify-content-between mt-4">
            <div className="d-flex align-items-baseline footer-icons">
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-instagram rotate-icon"
                viewBox="0 0 16 16"
              >
              ...
              <svg
                ...
                height="16"
                fill="currentColor"
                class="bi bi-envelope rotate-icon"
                viewBox="0 0 16 16"
              >
